...
jQuery(document).ready(function ($) {
    ...
    $("#btnQuery").bind("click", function () {
        ...
        var tbTable = $("#_CourseScheduleTable").DataTable();
    ...
    $('#btnShedule').click(function () {
        $.ajax({
            url: '/Admins/CourseSchedule/Schedule',
            data: null,
            type: 'post',
            cache: false,
            dataType: 'json',
...
//加载表数据
function InitTable() {
    table = $("#_CourseScheduleTable").dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "/Admins/CourseSchedule/GetDataTable",
            "type": "POST",
            "data": {
                majorId: $.trim($("#ddlMajorForSchedule").val())
            },
